Download and save the files gui_ann_pso_full.py, ann_pso_model.json, and requirements_install.py in a single folder.
...
Through either of the preferred platforms, open the folder containing the files gui_ann_pso_full.py, ann_pso_model.json, and requirements_install.py.

Run the file requirements_install.py once for the installation of required Python packages.

After installation, run gui_ann_pso_full.py to launch the ANN-PSO Compressive Strength Predictor.
